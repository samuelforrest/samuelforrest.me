...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Samuel Forrest is a 17-year-old aspiring Software Engineer studying Computer Science, Physics & Mathematics A-Levels in London. Private tutor, web developer, and entrepreneur.',
  ...
  twitter: {
    ...
    title: 'Samuel Forrest | Software Engineer & A-Level Student',
    description: 'Samuel Forrest is a 17-year-old aspiring Software Engineer studying Computer Science, Physics & Mathematics A-Levels in London.',
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "knowsAbout": ["Software Engineering", "Web Development", "Computer Science", "Mathematics", "Physics", "Private Tutoring"],
              "sameAs": [
                "https://linkedin.com/in/samueljforrest",
                "https://github.com/samuelforrest",
                "https://instagram.com/samueljforrest"
              ],
              "address": {
                "@type": "Place",
